...
public class BehaviorSelection : MonoBehaviour
{
    ...
    private Dictionary<int, BehaviorDesigner.Runtime.BehaviorTree> behaviorTreeGroup = new Dictionary<int, BehaviorDesigner.Runtime.BehaviorTree>();
    ...
    public void Start()
    {
        var behaviorTrees = mainBot.GetComponents<BehaviorDesigner.Runtime.BehaviorTree>();
        for (int i = 0; i < behaviorTrees.Length; ++i) {
            behaviorTreeGroup.Add(behaviorTrees[i].Group, behaviorTrees[i]);
        }
        behaviorTrees = Camera.main.GetComponents<BehaviorDesigner.Runtime.BehaviorTree>();
        for (int i = 0; i < behaviorTrees.Length; ++i) {
            behaviorTreeGroup.Add(behaviorTrees[i].Group, behaviorTrees[i]);
        }
